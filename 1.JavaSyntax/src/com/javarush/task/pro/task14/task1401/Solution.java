...
public class Solution {
    ...
    static void addUser(User user) {
        ...
        if (statusName == -1) System.out.println(CANNOT_BE_NULL);
        else if (statusName == -2) System.out.println(CANNOT_BE_EMPTY);
        else if (statusName == -3) System.out.println(CANNOT_CONTAIN_DIGIT);
        else if (statusName != 0) System.out.println(UNKNOWN_ERROR);

        int statusAge = user.setAge(age);
        if (statusAge == -1) System.out.println(CANNOT_BE_NEGATIVE);
        else if (statusAge == -2) System.out.println(CANNOT_BE_TOO_BIG);
        else if (statusAge != 0) System.out.println(UNKNOWN_ERROR);
