...
//        switch (dayOfWeek) {
//            case FRIDAY:
//                return hour >= WEEKEND_START_FRIDAY_CUT_OFF_HOUR;
//            case SATURDAY:
//                return true;
//            case SUNDAY:
//                return hour < WEEKEND_END_SUNDAY_CUT_OFF_HOUR;
//            default:
//                return false;
//        }
//    }
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        return switch (dayOfWeek) {
            case FRIDAY -> hour >= WEEKEND_START_FRIDAY_CUT_OFF_HOUR;
            case SATURDAY -> true;
            case SUNDAY -> hour < WEEKEND_END_SUNDAY_CUT_OFF_HOUR;
            default -> false;
        };
    }
}
